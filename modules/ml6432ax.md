...
The `ML6432Ax` series is also used as the radar-board family in the `WDR` product line. In that system context, both `ML6432A` and `ML6432A_BO` remain electrically compatible on the radar side, but they differ in the way they are installed into the controller platform.

- `ML6432A_BO` is the preferred direct-plug option for `WDR-M`.
...
Additional integration references from the WDR material are shown below.
...
<div style="text-align: center; margin: 10px 0;">
  ...
  <img src="./img/MDR/ml6432a-connector-pin-assignment.png" alt="ML6432A P1 and P2 position reference" width="38%" style="display: inline-block; margin: 0 12px;" />
...
<div style="text-align: center; margin: 10px 0;">
  ...
  <p style="margin: 4px 0 0 0;">Signal schematic reference used in WDR integration material</p>
</div>

For controller and system-level information about the complete WDR assembly, refer to [wdr-m.md](./wdr-m.md).
